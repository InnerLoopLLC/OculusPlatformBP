...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FAchievements_GetAllDefinitions, UOBP_AchievementDefinitionArray*, AchievementDefinitionArray);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FAchievements_GetAllProgress, UOBP_AchievementProgressArray*, AchievementProgressArray);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FAchievements_GetDefinitionsByName, UOBP_AchievementDefinitionArray*, AchievementDefinitionArray);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FAchievements_GetNextAchievementDefinitionArrayPage, UOBP_AchievementDefinitionArray*, AchievementDefinitionArray);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FAchievements_GetNextAchievementProgressArrayPage, UOBP_AchievementProgressArray*, AchievementProgressArray);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FAchievements_GetProgressByName, UOBP_AchievementProgressArray*, AchievementProgressArray);
