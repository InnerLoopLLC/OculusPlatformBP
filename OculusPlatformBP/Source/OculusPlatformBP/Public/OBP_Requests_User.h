...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FUser_GetLoggedInUserFriends, UOBP_UserArray*, LoggedInUserFriends);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FUser_GetLoggedInUserFriendsAndRooms, UOBP_UserAndRoomArray*, LoggedInUserFriendsAndRooms);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FUser_GetLoggedInUserRecentlyMetUsersAndRooms, UOBP_UserAndRoomArray*, LoggedInUserRecentlyMetUsersAndRooms);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FUser_GetNextUserAndRoomArrayPage, UOBP_UserAndRoomArray*, NextUserAndRoomArray);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FUser_GetNextUserArrayPage, UOBP_UserArray*, NextUserArray);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FUser_GetOrgScopedID, FString, OrgScopedID);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FUser_GetSdkAccounts, UOBP_SdkAccountArray*, SdkAccounts);
